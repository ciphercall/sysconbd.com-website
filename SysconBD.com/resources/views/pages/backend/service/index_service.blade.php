                    ...
                    <tr class="odd">
                        ...
                        <td class="text-right py-0 align-middle">
							<div class="btn-group btn-group-sm">
                                <a class="btn btn-info" href="#" data-toggle="modal" data-target="#view_service"><i class="fas fa-eye"></i></a>&nbsp;
		...
		$(document).on('click','#editservice',function(){
			...
			$.ajax({
				...
				success:function(response){
					...
					$("#eAttach_file").html(
                        `<img src="img/${response.service.attach_file}" width="100" class="img-fluid img-thumbnail">`);
