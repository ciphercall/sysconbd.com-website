...
<div id="content" class="site-content">
    <div class="page-header flex-middle">
        <div class="container">
            <div class="inner flex-middle">
                <h1 class="page-title" style="font-weight:600;">Our Team</h1>
    ...
    <section class="team-top space-sm-top">
        <div class="container pb-5">
            <h2 class="team-top-title">Meet the Team of SYSCON Engineering</h2>
        </div>
        <div class="container-fluid text-center">
            <img src="{{url('frontend/images/background/team.webp')}}" alt="">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="technology-left">
                        ...
                        <p>Our people crucial in the delivery of our services and solutions to the clients.
                ...
                <div class="col-lg-6" style="padding-top:50px;">
                    <div class="about-right">
                        <img class="home-about-video d-flex justify-content-center" src="{{url('frontend/images/about1.png')}}" alt="">
